                                ...
                                <div class="block">
                                    ...
                                    <!-- Basic Form Elements Content -->
                                     {{ Form::open(array('method' => 'GET','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/productos/crearproducto'))) }}
                                        ...
                                        <div class="form-group hidden-lg hidden-xl hidden-xs hidden-md hidden-sm">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         <label class="col-md-3 control-label" for="example-password-input">Imagen</label>
                                          <div class="col-md-9">
                                           <div class="input-group">
                                            <input type="text" id="image_labela" class="form-control" name="FilePatha" placeholder="Seleccionar imagen" aria-label="Imagea" aria-describedby="button-imagea">
                                        ...
                                        <div class="form-group">
                                         <label class="col-md-3 control-label" for="example-password-input">Imagen</label>
                                          <div class="col-md-9">
                                           <div class="input-group">
                                            <input type="text" id="image_labelb" class="form-control" name="FilePathb" placeholder="Seleccionar imagen" aria-label="Image" aria-describedby="button-imageb">
                                        ...
                                        <div class="form-group">
                                         <label class="col-md-3 control-label" for="example-password-input">Imagen</label>
                                          <div class="col-md-9">
                                           <div class="input-group">
                                            <input type="text" id="image_labelc" class="form-control" name="FilePathc" placeholder="Seleccionar imagen" aria-label="Image" aria-describedby="button-imagec">
                                        ...
                                        <div class="form-group">
                                         <label class="col-md-3 control-label" for="example-password-input">Imagen</label>
                                          <div class="col-md-9">
                                           <div class="input-group">
                                            <input type="text" id="image_labeld" class="form-control" name="FilePathd" placeholder="Seleccionar imagen" aria-label="Image" aria-describedby="button-imaged">
                                        ...
                                        <div class="form-group">
                                         <label class="col-md-3 control-label" for="example-password-input">Imagen</label>
                                          <div class="col-md-9">
                                           <div class="input-group">
                                            <input type="text" id="image_labele" class="form-control" name="FilePathe[]" placeholder="Seleccionar imagen" aria-label="Image" aria-describedby="button-imagee">
                                            <span class="input-group-btn"><button class="btn btn-primary" type="button" id="button-imagee">Seleccionar imagen</button></span>
                                           </div>
                                          </div>
                                        </div>
...
<script>
  ...
  // set file link
  function fmSetLink($url) {
    document.getElementById('image_labeld').value = $url;
  }
</script>

<script>
  document.addEventListener("DOMContentLoaded", function() {
    document.getElementById('button-imagee').addEventListener('click', (event) => {
      event.preventDefault();
      window.open('/file-manager/fm-button', 'fm', 'width=900,height=500');
    });
  });
  // set file link
  function fmSetLink($urle) {
    document.getElementById('image_labele').value = $urle;
  }
</script>
