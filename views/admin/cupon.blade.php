                            ...
                            <div class="col-md-12">
                                ...
                                <div class="block">
                                    ...
                                    <div class="block-title">
                                        ...
                                        <h2><strong>Crear</strong> Cupón</h2>
                                    </div>
                                    <!-- END Form Elements Title -->
                                    
                                    <!-- Basic Form Elements Content -->
                                      {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('gestion/carrito/createcupon'))) }}

                                        
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-text-input">Porcentaje Descuento</label>
                                            <div class="col-md-9">
                                               {{Form::text('porcentaje', '', array('class' => 'form-control','placeholder'=>'Ingrese porcentaje de descuento','required' => 'required'))}}
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label class="col-md-3 control-label" for="example-email-input">Código cupón</label>
                                            <div class="col-md-9">
                                                {{Form::text('codigo', Str::random(10), array('class' => 'form-control','placeholder'=>'Ingrese descripción','required' => 'required'))}}
                                            </div>
                                        </div>
