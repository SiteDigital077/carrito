...
return confirm( mensaje );}
    ...
    <a href="<?=URL::to('gestion/carrito/eliminarproducto/');?>/{{ $subcategorias->id }}" onclick="return confirmar('¿Está seguro que desea eliminar el registro?')"><span id="tup" data-toggle="tooltip" data-placement="bottom" title="Eliminar Categoria" class="btn btn-danger"><i class="hi hi-trash sidebar-nav-icon"></i></span></a>
    <a href="<?=URL::to('gestion/productos/programacion/');?>/{{ $subcategorias->id }}"><span id="tup" data-toggle="tooltip" data-placement="right" title="Programar Ruta" class="btn btn-info"><i class="fa fa-calendar-plus-o"></i></span></a>
                                            </td>
                                        </tr>
                                      @endforeach 
