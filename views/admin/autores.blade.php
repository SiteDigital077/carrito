...
<div class="container">
<a href="/gestion/carrito/crear-autor" class="btn btn-primary pull-right">Crear Autor</a>
<br>
<br>
<br>
</div>
...
<div class="container">
 ...
 <div class="block full">
                            <div class="block-title">
                                <h2><strong>Autores</strong> Registrados</h2>
                            </div>
                            ...
                            <div class="table-responsive">
                                <table id="example-datatable" class="table table-vcenter table-condensed table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td class="text-center">{{$autores->id}}</td>
                                            <td class="text-center">{{$autores->nombre}}</td>
                                            <td>{{$autores->pais}}</td>
                                          
                                            <td class="text-center">
                                                <div class="btn-group">
                                                   <a href="<?=URL::to('gestion/autor/editar/');?>/{{ $autores->id }}"><span  id="tip" data-toggle="tooltip" data-placement="left" title="Editar Autor" class="btn btn-primary"><i class="fa fa-pencil-square-o sidebar-nav-icon"></i></span></a>
                                                  <a href="<?=URL::to('gestion/autor/eliminar/');?>/{{$autores->id}}" onclick="return confirm('¿Está seguro que desea eliminar el registro?')"><button ="button" class="btn btn-danger" data-toggle="tooltip" data-placement="right" title="Eliminar Autor"><i class="hi hi-trash sidebar-nav-icon"></i></button></a>
                                                </div>
                                            </td>
                                        </tr>
