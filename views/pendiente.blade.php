...
@foreach($resultadowebpen as $resultadowebpen)
      ...
      <table class="table table-borderless table-striped table-vcenter">
       <tbody>
        ...
        <tr>
         ...
         <td>{{$resultadowebpen->referencia}}</td>
        </tr>
        
        <tr>
         <td class="text-right"><strong>Fecha y hora de la transacción</strong></td>
         <td>{{$resultadowebpen->fecha}}</td>
        </tr>

        <tr>
         <td class="text-right"><strong>Número de autorización</strong></td>
         <td>{{$resultadowebpen->codigo}}</td>
        </tr>
        
        <tr>
         <td class="text-right"><strong>Total</strong></td>
         <td>$ {{number_format($resultadowebpen->shipping+$resultadowebpen->cos_envio,0,",",".")}}</td>
        </tr>
        <tr>
